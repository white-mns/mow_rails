...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { block_no: @block.block_no, e_no: @block.e_no, generate_no: @block.generate_no, result_no: @block.result_no } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { block_no: @block.block_no, e_no: @block.e_no, generate_no: @block.generate_no, result_no: @block.result_no } }
